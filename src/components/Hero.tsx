...
const Hero = () => {
  return (
    ...
    <div className='min-h-screen bg-cover bg-center bg-no-repeat' style={{ backgroundImage: `url("${image}")` }}>
      <div className='min-h-screen container max-w-6xl mx-auto px-4 py-14 flex flex-col justify-center h-full'>
        ...
        <div className='text-base md:text-lg lg:text-2xl max-md:text-center'>
          <motion.a
            ...
            {HeroText.Button} <span className='relative group-hover:-left-1'><FiArrowLeft /></span>
          </motion.a>
        </div>
      </div>
